...
// 让图标和文字之间空开
.mg-button [class*='mg-icon-'] + span {
  margin-left: 5px;
}
// 禁用
.mg-button.mg-button.is-disabled .mask {
  position: absolute;
  width: 100%;
  height: 100%;
...
.mg-button.is-round .mask {
  border-radius: 20px;
}
.mg-button.is-circle .mask {
  border-radius: 50%;
}
